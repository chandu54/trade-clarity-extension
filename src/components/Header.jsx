...
const USFlag = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480" className="flag-icon">
...
const SunIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="sun-icon">
    ...
    <div className="header">
      <div className="header-title">
        <div className="brand-lockup">
          <h2 className="app-name" onClick={() => window.location.reload()}>
            <span className="brand-primary">TradeClarity</span>
            <span className="brand-dot">.</span>
            <span className="brand-secondary">market</span>
          </h2>
      ...
      <div className="header-actions">
        ...
        <button className="system-reset-btn" onClick={handleClearAll} title="Reset All Application Data">
